var win = new function () {
    ...
    //成功提示框
     ...
     this.infoAlert= function ( message, closed) {
        ...
        var html = '<div class="win"><div class="mask-layer"></div><div class="window-panel info"><div class="title-panel" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></div><div class="title title-info"></div><a href="javascript:void(0)" onclick="win._close();" class="close-btn" title="关闭">×</a><div class="body-panel"><p class="content"></p><p class="btns"><a href="#" class="w-btn" tabindex="1" onclick="win._close();">确定</a></p></div></div></div>';
        messageBox(html, message);
		//setTimeout(function () { win.close();}, 2000);
    }
