  ...
  <area shape="circle" coords="313,330,162" href="v.htm">
		...
		<div class="container-fluid sec-maincontent">
			...
			<c:if test="${fn:contains(bimShow_ButtonList,'&bs_sp4&')}">
				<li>
					<a id="dept_2"  onclick="activeDeptIcon(2)"  href="javascript:void(0);" class="active">
						<i class="iconfont icon-hangzheng"></i>
						<span>行政办公</span>
					</a>
				</li>
...
<!-- 			<li>
			...
			<div class="right-content">
				<iframe onload="resize_iframe_height(this)" id="mainFrame" name="mainFrame" scrolling="no" src="${pageContext.request.contextPath}/views/home/homeTB/hm.jsp" frameborder="0" style="padding: 0px; width: 100%; "></iframe>
			</div>
		</div>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/views/home/homeTB/js/echart/sec-curve.js" ></script>
	 -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/views/home/homeTB/js/home2th.js" ></script>
	...
	<script>
		var resize_iframe_height = function(ifm){
			...
			ifm.style.height = Math.max(ifm.contentDocument.body.scrollHeight,$('.left_menu').height())+'px';
		};
