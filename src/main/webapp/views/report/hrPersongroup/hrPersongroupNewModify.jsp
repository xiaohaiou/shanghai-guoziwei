...
<body>
	<c:choose>
		<c:when test="${op eq 'modify'}">
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>修改财务人员资质数据
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:when>
		<c:otherwise>
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>新增财务人员资质数据
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:otherwise>
		...
		<form:form id="form2" modelAttribute="entityview" >
	        	...
	        	<label class="w20">财务人员资质数据:</label>
				
				<input type="file" class="w75 inlineblock" style="display:inline" name="itemFile" id="itemFile" >
				
			    <label class="w20">财务人员编制数据:</label>
				
				<input type="file" class="w75 inlineblock" style="display:inline" name="organizationFile" id="organizationFile" >
...
<script type="text/javascript">
		...
		$("#commit-1").click(function(){
			...
			var url = "${pageContext.request.contextPath}/hrPersongroup/save";
		...
		$("#commit-2").click(function(){
			...
			var url = "${pageContext.request.contextPath}/hrPersongroup/saveandreport";
