...
<body>
	<c:choose>
		<c:when test="${op eq 'report'}">
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>上报财务人员资质数据
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:when>
		<c:otherwise>
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>查看财务人员资质数据
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:otherwise>
...
<script type="text/javascript">
		...
		function exam(id){	
			...
			var url = "/shanghai-gzw/hrPersongroup/saveandreport?id=" + id;
