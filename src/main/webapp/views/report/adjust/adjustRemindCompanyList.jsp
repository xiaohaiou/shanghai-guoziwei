...
<html>
	...
	<body>
		...
		<form id="form1"  class="row"  >
			...
			<input type="hidden" name="organalID" value="${organalID}"/>			
			<input type="hidden" name="organalname" value="${organalname}"/>			
			<input type="hidden" name="formKind" value="${formKind}"/>			
			<input type="hidden" name="CompanyKind" value="${CompanyKind}"/>		
			<span class="col-md-12" style="text-align: right">
				<c:if test="${fn:contains(gzwsession_code,',bimWork_hswcjgscx_wtb_remind,')==true }">	<!--bimWork_hswcjgscx_wtb_remind  -->
	...
	<script type="text/javascript">
		...
		function commondOn(){
			var form = document.forms[0];
			form.action = "${pageContext.request.contextPath}/reportadjust/commondDown";
			form.method = "post";
			form.submit();	
		}
