...
<body>
	<h4>
		<span class="glyphicon glyphicon-pencil"></span>审核创新类融资项目进展数据
	...
	<div class="label_inpt_div">
		<form:form id="form2" modelAttribute="entityview" >
			...
			<div class="model_part">
				...
				<label class="w25 setleft">${ entityview.projectName}</label> 
				...
				<label class="w75 setleft" style="word-wrap:break-word;">${entityview.operationDepartment }</label>
				<label class="w20">融资结构:</label>
				<label class="w75 setleft" style="word-wrap:break-word;">${ entityview.financingStructure}</label> 
				<label class="w20">融资进展:</label>
				<label class="w75 setleft" style="word-wrap:break-word;">${entityview.financingProgress }</label>
...
<script type="text/javascript">
		...
		$("#commit-1").click(function(){
			if(check())
			{
				$.post("/shanghai-gzw/reportFinancingInnovate/commitexam",{entityid:$("#entityid").val(),examStr:$("#examStr").val(),examResult:50116},function(data){
		...
		$("#commit-2").click(function(){
			if(check())
			{
				$.post("/shanghai-gzw/reportFinancingInnovate/commitexam",{entityid:$("#entityid").val(),examStr:$("#examStr").val(),examResult:50117},function(data){
		    		var commitresult=JSON.parse(data);
							if(commitresult.result==true)
