...
<body>
	<c:choose>
		<c:when test="${op eq 'report'}">
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>上报现金流周执行数据
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:when>
		<c:otherwise>
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>查看现金流周执行数据
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:otherwise>
...
<script type="text/javascript">
		...
		function exam(id){
			...
			var url = "/shanghai-gzw/reportCashflowWeeklyExecute/listandreport?id=" + id;
