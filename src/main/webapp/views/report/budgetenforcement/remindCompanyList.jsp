...
<html>
	...
	<body>
		...
		<form id="form1"  class="row"  >		
			...
			<span class="col-md-12" style="text-align: right">
				<c:if test="${fn:contains(gzwsession_code,',bimWork_yszxbbsb_wtb_remind,')==true }">	
	...
	<script type="text/javascript">
		...
		function back(){
			...
			form.action = "${pageContext.request.contextPath}/reportbudgetenforcement/ysNoCreateCompanyList";
			form.method = "post";
			form.submit();		
		}
		...
		function commondOn(){
			var form = document.forms[0];
			form.action = "${pageContext.request.contextPath}/reportbudgetenforcement/commondDown";
			form.method = "post";
			form.submit();	
		}
