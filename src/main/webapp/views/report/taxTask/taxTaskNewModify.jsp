...
<body>
	<h4>
		<span class="glyphicon glyphicon-pencil"></span>节税任务数据导入
	...
	<div class="label_inpt_div">
		<form:form id="form2" enctype="multipart/form-data" method="post" modelAttribute="entityview" >
			...
			<div class="model_part">
				...
				<label class="w20"><span class="required"> * </span>节税任务数据文件:</label>
...
<script type="text/javascript">
		...
		$("#commit-1").click(function(){
			...
			var url = "${pageContext.request.contextPath}/taxTask/save";
					...
					if (commitresult.result == true) {
						...
						if(commitresult.entity==1){
						    win.confirm(commitresult.exceptionStr,function(r){
								if(r){
									var url = "${pageContext.request.contextPath}/taxTask/save?isConfirm=1";
									var formData = new FormData($("#form2")[0]);
									$.ajax({
										url : url,
										type : "POST",
		...
		$("#commit-2").click(function(){
			...
			var url = "${pageContext.request.contextPath}/taxTask/saveandreport";
			var formData = new FormData($("#form2")[0]);
			$.ajax({
				url : url,
				type : "POST",
				...
				success : function(data) {
					...
					if(commitresult.result==true) {
						...
						if(commitresult.entity==1){
						    win.confirm(commitresult.exceptionStr,function(r){
								if(r){
									var url = "${pageContext.request.contextPath}/taxTask/saveandreport?isConfirm=1";
									var formData = new FormData($("#form2")[0]);
									$.ajax({
										url : url,
										type : "POST",
