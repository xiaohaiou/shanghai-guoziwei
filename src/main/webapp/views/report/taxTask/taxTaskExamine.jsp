...
<body>
	<h4>
		<span class="glyphicon glyphicon-pencil"></span>审核节税任务数据
...
<script type="text/javascript">
		...
		function addTableHtml(data,tableId,num){
			if(data != null){
				var tr="<tr><td>"+data.orgName+"</td>";//单位
		...
		$("#commit-1").click(function(){
			if(check()){
				$.post("/shanghai-gzw/taxTask/commitexam",{entityid:$("#entityid").val(),examStr:$("#examStr").val(),examResult:50116},function(data){
		...
		$("#commit-2").click(function(){
			if(check()){
				$.post("/shanghai-gzw/taxTask/commitexam",{entityid:$("#entityid").val(),examStr:$("#examStr").val(),examResult:50117},function(data){
					var commitresult=JSON.parse(data);
					if (commitresult.result == true) {
