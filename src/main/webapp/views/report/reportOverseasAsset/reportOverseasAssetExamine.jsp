...
<body>
			...
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>审核境外资产占比数据
...
<script type="text/javascript">
		...
		$("#commit-1").click(function(){
			if(check())
			{
				$.post("/shanghai-gzw/reportOverseasAsset/commitexam",{entityid:$("#entityid").val(),examStr:$("#examStr").val(),examResult:50116},function(data){
		...
		$("#commit-2").click(function(){
			if(check())
			{
				$.post("/shanghai-gzw/reportOverseasAsset/commitexam",{entityid:$("#entityid").val(),examStr:$("#examStr").val(),examResult:50117},function(data){
		    		var commitresult=JSON.parse(data);
							if(commitresult.result==true)
