		...
		<form id="form1"  class="row"  >
			<span class="col-md-3">
				<span class="search_title">周数：</span>
					<input  type="text" value="${entityview.year }" name="year" readonly class="time time_short" style="width:150px;height:30px" />
					<select  name="week" id="week" style="width:100px;height:30px" >
					<option value=""  ></option>
			...
			<span class="col-md-4">
				<span class="search_title">融资进度：</span>
					<select  name="progress" class="selectpicker" >
						<option value="done" <c:if test="${option == 'done'}">selected="selected"</c:if>>已完成</option>
						<option value="waiting" <c:if test="${option == 'waiting'}">selected="selected"</c:if>>待下账</option>
					</select>			
			</span>				
