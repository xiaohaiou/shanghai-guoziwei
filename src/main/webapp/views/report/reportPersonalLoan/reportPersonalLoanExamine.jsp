...
<body>
		...
		<form:form id="form2" modelAttribute="entityview" >
			<form:hidden path="id"/>
				...
				<label class="w25 setleft">${entityview.month}月</label>  
...
<script type="text/javascript">
		...
		$("#commit-1").click(function(){
			if(check())
			{
				$.post("/shanghai-gzw/reportpersonalLoan/commitexam",{entityid:$("#entityid").val(),examStr:$("#examStr").val(),examResult:50116},function(data){
		...
		$("#commit-2").click(function(){
			if(check())
			{
				$.post("/shanghai-gzw/reportpersonalLoan/commitexam",{entityid:$("#entityid").val(),examStr:$("#examStr").val(),examResult:50117},function(data){
		    		var commitresult=JSON.parse(data);
							if(commitresult.result==true)
