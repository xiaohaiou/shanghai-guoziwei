...
<body>
	<c:choose>
		<c:when test="${op eq 'report'}">
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>上报应收债权(外部)台账信息
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:when>
		<c:otherwise>
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>查看应收债权(外部)台账信息
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:otherwise>
...
<script type="text/javascript">
		...
		function exam(id){	
			...
			var url = "/shanghai-gzw/receivabledebtOuter/recheck?id=" + id;
