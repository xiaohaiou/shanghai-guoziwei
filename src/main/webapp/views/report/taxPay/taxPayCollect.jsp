...
<body>
	<h4>
		<span class="glyphicon glyphicon-pencil"></span>纳税数据汇总查看
		<i class="iconfont icon-guanbi"></i>
	</h4>
	<div class="model_body">
		<form:form id="form2" modelAttribute="list" >	
...
<%-- 					<label class="w20"><span class="required"> <font color=red>*</font> </span>单位名称:</label>
			...
			<%-- 	        <input name="id" type="hidden"  value="${entityview.id}"  />
				         <input name="hnTax" type="hidden"  value="${entityview.hnTax}"  />
				...
				<div>
					<h3 class="data_title1">汇总数据</h3>
						<div class="model_part">
							<label class="w20"><font color=red>*</font>本期纳税实缴（万元）:</label>
					        <input name="nowPay"  readonly="readonly" id ="sumNowpay" class="w25"  value="${entityBackInfo.nowPay}" /> 
							<label class="w20"><font color=red>*</font>去年同期纳税实缴（万元）:</label>
				            <input name="prevPay" readonly="readonly" id ="sumPrepay" class="w25"  value="${entityBackInfo.prevPay}" /> 
							 <div class="tablebox">
							      <table>
...
<script type="text/javascript">
		...
		*/
		...
		$("#commit_1").click(function(){
			...
			var url="${pageContext.request.contextPath}/taxPay/saveOrUpdate?op=save";
		...
		$("#commit_2").click(function(){
			...
			if(!vaild.all() || !checkcommit())
			{
					...
					//var entityBasicInfo = $('#form2').serialize();
			var url = "${pageContext.request.contextPath}/taxPay/saveAndReport?op=saveR";
