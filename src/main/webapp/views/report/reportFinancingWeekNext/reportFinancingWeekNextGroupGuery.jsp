...
<html>
	...
	<body>
		...
		<form id="form1"  class="row" >
			...
			<div class="form_div col-md-12">
				...
				<c:if test="${fn:contains(gzwsession_code,',bimWork_bzrzjzTb_q,')==true }"> <!-- bimWork_xzrzjzTb_cxhjz -->
	...
	<script type="text/javascript">
		...
		function _query()
		{
			...
			form.action = "/shanghai-gzw/reportFinancingWeekNext/g_query";
			form.method = "post";
			form.submit();		
		}
