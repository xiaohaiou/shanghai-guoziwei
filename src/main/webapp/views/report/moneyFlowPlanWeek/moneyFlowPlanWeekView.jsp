...
<body onload="loadData()">
	<c:choose>
		<c:when test="${op eq 'report'}">
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>上报现金流周计划数据
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:when>
		<c:otherwise>
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>查看现金流周计划数据
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:otherwise>
	</c:choose>
...
<script type="text/javascript">
		...
		$("#commit_1").click(function(){
			$.post("/shanghai-gzw/moneyFlowPlanWeek/postexam?pid="+$("#entityid").val(),function(data){
