	...
	<body>
		...
		<form id="form1"  class="row"  >
			...
			<div class="form_div col-md-12">
					<c:if test="${fn:contains(gzwsession_code,',bimWork_xjlzjhTb_q,')==true }">	
						<input type="button" value="查询" class="form_btn" id="qrybtn" onclick="_query()">
					</c:if>
					<c:if test="${fn:contains(gzwsession_code,',bimWork_xjlzjhTb_n,')==true }">		
						<input type="button" value="新增" class="form_btn" id="addbtn" onclick="mload('${mapurl}/newmodify')">
					</c:if>	
					<c:if test="${fn:contains(gzwsession_code,',bimWork_xjlzjhTb_hzcx,')==true }"> <!--bimWork_xjlzjhTb_hzcx-->
						<input type="button" value="汇总查询" class="form_btn" id="addbtn" onclick="mload('${mapurl}/g_query')">
					</c:if>
					<c:if test="${fn:contains(gzwsession_code,',bimWork_xjlzjhTb_export,')==true }">
	...
	<script type="text/javascript">
		...
		function del(id){
			win.confirm('确定要删除？',function(r){
				if(r){
					var url = "/shanghai-gzw/moneyFlowPlanWeek/delete?pid=" + id;
