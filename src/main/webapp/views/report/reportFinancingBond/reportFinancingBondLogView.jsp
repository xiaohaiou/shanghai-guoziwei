...
<body>
	<h4>
		<span class="glyphicon glyphicon-pencil"></span>查看债券类融资项目进展更新日志
		<i class="iconfont icon-guanbi"></i>
	</h4>
	<div class="label_inpt_div">
		<form:form id="form2" modelAttribute="entityview" >
			<h3 class="data_title1">债券类融资项目基本信息
			</h3>
			...
			<div class="model_part">
				<div id="reportFinancingBondLogDetailList">
...
<script type="text/javascript">
	...
	initNodeList('reportFinancingBondLogDetail',1,"",data1);
