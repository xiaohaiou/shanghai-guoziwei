	...
	<body>
		...
		<form id="form1"  class="row"  >
			...
			<span class="col-md-4">
				...
				<input  type="text" name="date" value="${date}" readonly class="time1 time_long" />
			<%-- 	<input type="hidden" id="startyear" name="startyear" value="${entityview.startyear }">
				...
				<input  type="hiden" value="${entityview.endtime }" name="endtime" readonly class="time2 time_short" />   
