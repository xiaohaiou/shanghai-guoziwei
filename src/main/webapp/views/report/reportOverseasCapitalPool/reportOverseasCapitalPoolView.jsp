...
<body>
	<c:choose>
		<c:when test="${op eq 'report'}">
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>上报境外资金池建设数据
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:when>
		<c:otherwise>
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>查看境外资金池建设数据
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:otherwise>
...
<script type="text/javascript">
		...
		function exam(id){
			...
			var url = "/shanghai-gzw/reportOverseasCapitalPool/saveandreport?id=" + id;
