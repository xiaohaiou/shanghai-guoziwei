	...
	<body>
		...
		<form id="form1"  class="row"  >
			...
			<div class="form_div col-md-12">
					<c:if test="${fn:contains(gzwsession_code,',bimWork_zrsTb_q,')==true }">	
						<input type="button" value="查询" class="form_btn" id="qrybtn" onclick="_query()">
					</c:if>	
					<c:if test="${fn:contains(gzwsession_code,',bimWork_zrsTb_n,')==true }">		
						  <input type="button" value="新增" class="form_btn" id="addbtn" onclick="mload('${mapurl}/newmodify')"> 
					</c:if>
					 <input type="button" value="汇总" class="form_btn" id="exportbtn" onclick="mload('${mapurl}/collect')">
					 ...
					 <c:if test="${fn:contains(gzwsession_code,',bimWork_zrsTb_synchronization,')==true }">
	...
	<script type="text/javascript">
		...
		*/
		...
		function tb(){
			...
			var url="${pageContext.request.contextPath}/headCount/getOverviewIndustry?year="+year+"&month="+month+"&NodeId="+NodeId;
