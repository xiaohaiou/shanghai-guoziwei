...
<body>
	<c:choose>
		<c:when test="${op eq 'check'}">
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>查看产权信息数据
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:when>
		<c:otherwise>
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>上报产权信息数据
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:otherwise>
	</c:choose>
	<form:form id="form2" modelAttribute="entity" >
		<div class="label_inpt_div">
			...
			<h3 class="data_title1">产权信息</h3>
				<div class="model_part">
					<label class="w20">产权信息数1:</label>
					<label class="w25 setleft" >${entity.workersNumber}</label> 
					<label class="w20">产权信息数2:</label>
