...
<body>
	<c:choose>
		<c:when test="${op eq 'modify'}">
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>重大事项数据
	...
	<form:form id="form2" modelAttribute="entityview" >
		...
		<div class="label_inpt_div">
			...
			<h3 class="data_title1">重大事项数据覆盖度</h3>
			<div class="model_part">
				<label class="w20"><span class="required"> * </span>重大事项数据总数(次):</label>
				<form:input class="w25" id="careCount" path="careCount" check="NotEmpty_int_10_0_0+_._."/>
				<label class="w20"><span class="required"> * </span>重大事项数据参与人次(人):</label>
				<form:input class="w25" id="carePerson" path="carePerson" check="NotEmpty_int_10_0_0+_._."/>
				<label class="w20"><span class="required"> * </span>重大事项数据参与度(人次):</label>
...
<script type="text/javascript">
		...
		$("#commit-1").click(function(){
			...
			var url = "${pageContext.request.contextPath}/hr/employeecare/save";
		...
		$("#commit-2").click(function(){
			...
			var url = "${pageContext.request.contextPath}/hr/employeecare/saveandreport";
			var formData = new FormData($("#form2")[0]);
			$.ajax({  
				url : url,  
				type : "POST",  
