...
<body>
	<h4>
		<span class="glyphicon glyphicon-pencil"></span>重大事项财务数据采集审核
...
<script type="text/javascript">
		...
		$("#commit-1").click(function(){
			$.post("/shanghai-gzw/hr/employeecare/commitexam",{entityid:$("#entityid").val(),examStr:$("#examStr").val(),examResult:50116},function(data){
		...
		$("#commit-2").click(function(){
			$.post("/shanghai-gzw/hr/employeecare/commitexam",{entityid:$("#entityid").val(),examStr:$("#examStr").val(),examResult:50117},function(data){
				var commitresult=JSON.parse(data);
				if(commitresult.result==true){
					win.successAlert('保存成功！',function(){
									parent.location.reload(true);
