...
<body>
	<c:choose>
		<c:when test="${op eq 'check'}">
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>查看信访数据采集
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:when>
		<c:otherwise>
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>上报信访数据采集
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:otherwise>
	</c:choose>
...
<script type="text/javascript">
		...
		$("#commit_1").click(function(){
			$.post("/shanghai-gzw/sixRateDc/postexam?id="+$("#entityid").val(),function(data){
