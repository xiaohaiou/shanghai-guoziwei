...
<c:choose>
		<c:when test="${op eq 'feedbackreport'}">
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>资源目录清单上报
		...
		<c:when test="${op eq 'feedbackexamine'}">
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>资源目录清单审核
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:when>
	...
	<form:hidden path="id"/>
		<div class="label_inpt_div">
			<h3 class="data_title1">上报单位</h3>
			<div class="model_part">
				<input type="hidden" value="${entity.id}" name="entityid" id="entityid">
				<label class="w20"><span class="required"> * </span>资源上报单位名称:</label>
				<span class="w25"> 
				...
				<label class="w20"><span class="required"> * </span>资源状态:</label>
				<input class="w25" name="eventForRisk" id="eventForRisk"  value="${entity.eventForRisk}" readonly="readonly"/>
				
				
				
				<label class="w20"><span class="required"> * </span>是否需要提醒资源使用状态:</label>
				<span class="w25">
				...
				--%>
				<label class="w20"><span class="required"> * </span>是否需要提醒资源剩余量:</label>
				<span class="w25">
				...
				<label class="w20"><span class="required"> * </span>上报单位所在省份:</label>
				<span class="w25">
			...
			<c:if test="${entity.ishighunit == 0}">
				<label class="w20">拟采取的资源状态应对措施:</label>
				<input class="w25" name="planmeasure" id="planmeasure" value="${entity.planmeasure}" readonly="readonly"/>
				
				<label class="w20"><span class="required"> * </span>预计资源使用完毕的时间:</label>
				<span class="w25">
