...
<body style="height:700px;">
	<h4>
		<span class="glyphicon glyphicon-pencil"></span>关联风险事件目录
	...
	<form:hidden path="id"/>
		<div class="label_inpt_div">
			...
			<div class="model_part">
				...
				<label class="w20"><span class="required"> * </span>风险信息标题:</label>
			...
			<h3 class="data_title1">关联目录列表(若修改请删除后新增)&nbsp;&nbsp;<a href="javascript:void(0)" onclick="addRelevance()" class="form_btn">新增</a> </h3>
			<div class="tablebox">
					...
					<c:if test="${!empty requestScope.relevanceList }">
						<c:forEach items="${ requestScope.relevanceList}" var="l"
							...
							<tr>
								...
								<td><a href="javascript:void(0)" onclick="removeRelevance(this)">删除</a></td>
							</tr>
						</c:forEach>
					</c:if>
				</table>
