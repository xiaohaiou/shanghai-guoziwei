...
<body style="height:500px;">
	<c:choose>
		<c:when test="${op eq 'modify'}">
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>修改待调查事项核查情况
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:when>
		<c:otherwise>
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>新增待调查事项核查情况
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:otherwise>
	</c:choose>
	...
	<form:hidden path="id"/>
		<div class="label_inpt_div">
			...
			<div class="model_part">
				<label class="w20"><span class="required"> * </span>待调查具体事项:</label>
