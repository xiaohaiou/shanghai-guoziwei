	...
	<form:form id="form2" modelAttribute="entity" >
		<div class="label_inpt_div">
			...
			<div class="model_part">
				...
				<label class="w20"><span class="required"> * </span>现场调查结束时间:</label>
				<input class="w25 time" name="endTime" id="endTime" check="NotEmpty_string_._._._._." value="${entity.endTime}" readonly="true"/>
			</div>
			
			
			<h3 class="data_title1">举报投诉反映问题线索核查情况(举报投诉调查必填) <a href="javascript:void(0)"
											onclick="mload('${mapurl}/addOrModifySituation?op=add&dataType=0&complianceId=${entity.id }')" class="form_btn">新增</a></h3>
			<div class="tablebox">
				<table>
					<tr class="table_header">
						...
						<c:forEach items="${ requestScope.situationList0}" var="l"
							...
							<tr>
								...
								<td>
									...
									<a href="javascript:void(0)"
											onclick="mload('${mapurl}/addOrModifySituation?op=modify&dataType=0&situationId=${l.id }')">修改</a>
									<a href="javascript:;" onclick="del('${l.id}','situation')">删除</a>
								</td>
							</tr>
						</c:forEach>
					</c:if>
			...
			<h3 class="data_title1">待调查事项核查情况(专项合规检查必填) <a href="javascript:void(0)"
											onclick="mload('${mapurl}/addOrModifySituation?op=add&dataType=1&complianceId=${entity.id }')" class="form_btn">新增</a></h3>
			<div class="tablebox">
				<table>
					<tr class="table_header">
						<th style="width:3%">序号</th>
						...
						<c:forEach items="${ requestScope.situationList1}" var="l"
							...
							<tr>
								...
								<td>
									...
									<a href="javascript:void(0)"
										onclick="mload('${mapurl}/addOrModifySituation?op=modify&dataType=1&situationId=${l.id }')">修改</a>
								
									<a href="javascript:;"
										onclick="del('${l.id}','situation')">删除</a>
								</td>
							</tr>
						</c:forEach>
					</c:if>
			...
			<h3 class="data_title1">调查发现其他违规违纪事件情况  <a href="javascript:void(0)"
											onclick="mload('${mapurl}/addOrModifySituation?op=add&dataType=2&complianceId=${entity.id }')" class="form_btn">新增</a></h3>
			<div class="tablebox">
				<table>
					<tr class="table_header">
						<th style="width:3%">序号</th>
						...
						<c:forEach items="${ requestScope.situationList2}" var="l"
							...
							<tr>
								...
								<td>
									...
									<a href="javascript:void(0)"
										onclick="mload('${mapurl}/addOrModifySituation?op=modify&dataType=2&situationId=${l.id }')">修改</a>
			...
			<h3 class="data_title1">调查反映风险事项提示  <a href="javascript:void(0)"
											onclick="mload('${mapurl}/addOrModifyPrompt?op=add&complianceId=${entity.id }')" class="form_btn">新增</a></h3>
			<div class="tablebox">
				<table>
					<tr class="table_header">
						<th style="width:3%">序号</th>
						...
						<c:forEach items="${ requestScope.promptList}" var="l"
							...
							<tr>
								...
								<td>
									...
									<a href="javascript:void(0)"
										onclick="mload('${mapurl}/addOrModifyPrompt?op=modify&promptId=${l.id }')">修改</a>
								
									<a href="javascript:;"
										onclick="del('${l.id}','prompt')">删除</a>
								</td>
							</tr>
						</c:forEach>
					</c:if>
			...
			<h3 class="data_title1">提出合规建议情况  <a href="javascript:void(0)"
											onclick="mload('${mapurl}/addOrModifySuggest?op=add&complianceId=${entity.id }')" class="form_btn">新增</a></h3>
			<div class="tablebox">
				<table>
					<tr class="table_header">
						<th style="width:3%">序号</th>
						...
						<c:forEach items="${ requestScope.suggestList}" var="l"
							...
							<tr>
								...
								<td>
									...
									<a href="javascript:void(0)"
										onclick="mload('${mapurl}/addOrModifySuggest?op=modify&suggestId=${l.id }')">修改</a>
								
									<a href="javascript:;"
										onclick="del('${l.id}','suggest')">删除</a>
								</td>
							</tr>
						</c:forEach>
					</c:if>
...
<script type="text/javascript">
		...
		function commit1(){
			...
			var url = "${pageContext.request.contextPath}/bimr/compliance/saveOrUpdate?type=manage";
		...
		function del(id,type){
			win.confirm('确定要删除？',function(r){
				if(r){
					var url = "${pageContext.request.contextPath}/bimr/compliance/delete"+type+"?"+type+"Id=" + id;
