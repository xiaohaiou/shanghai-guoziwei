...
<body>
	<h4>
		<span class="glyphicon glyphicon-pencil"></span>查看举报投诉反映问题线索核查情况
		<i class="iconfont icon-guanbi"></i>
	</h4>
	<form:form id="form2" modelAttribute="entity" >
		<div class="label_inpt_div">
			<div class="model_part">
				<label class="w20">举报投诉反映问题线索:</label>
				<label class="w70 setleft">${ entity.problem}</label>
				
				<label class="w20">问题线索是否属实:</label>
				<label class="w25 setleft">${ entity.isTruthName}</label>
				<br>
				<label class="w20">具体事实情况:</label>
