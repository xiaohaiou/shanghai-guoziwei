	...
	<body>
		...
		<form:form id="form1" modelAttribute="entity" method="post">
			...
			<div class="label_inpt_div">
				...
				<h4><span style="font-weight: 1px;">民事案件问责人员</span><a href="javascript:void(0)"
											onclick="mload('${pageContext.request.contextPath}/bimr/archives/companyTree/addCaseAccountable?projectId=${entity.id}&projectType=3')" class="form_btn">新增</a></h4>
					...
					<c:if test="${not empty accountable_list }">
						<c:forEach items="${accountable_list}" var="p" varStatus="status">
							<tr>
								...
								<a href="javascript:void(0)" onclick="mload('${pageContext.request.contextPath}/bimr/archives/companyTree/EmployeeAbilityInformation?accountablePeople=${p.accountabilityPersion}&accountablePeopleId=${p.accountabilityPersionId}&projecttype=3&id=${p.id}&projectId=${p.projectId }&questionId=0')">问责信息维护</a>
								</c:if>
