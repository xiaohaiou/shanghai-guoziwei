...
<html>
	...
	<body>
		<h4>
			<span class="glyphicon glyphicon-pencil"></span>刑事案件问责审核
		...
		<form:form id="form1" modelAttribute="entity" method="post">
			...
			<div class="label_inpt_div">
				...
				<h4><span style="font-weight: 1px;">刑事案件问责人员</span></h4>
			<div class="tablebox">
	...
	<script type="text/javascript">
		...
		$("#commit-1").click(function () {
		    ...
		    $.ajax({  
			     url : _url,  
			     type : "POST",  
			     data:{"projectId":projectId,"examStr" : op, "examResult" : examResult,"projectType":4},
		         async: false,  
		         cache: false,  
		         dataType:"text",  
			     success : function(data) {
