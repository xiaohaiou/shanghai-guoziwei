...
<body>
	...
	<form:form id="form2" modelAttribute="entity" >
		<div class="label_inpt_div">
			...
			<h3 class="data_title1">合规问责人员  </h3>
			<div class="tablebox">
				<table>
					<tr class="table_header">
						<th style="width:3%">序号</th>
					...
					<c:if test="${!empty requestScope.compliancePersionAbilities }">
						<c:forEach items="${ requestScope.compliancePersionAbilities}" var="l" varStatus="status">
							 ...
							 <tr>
								...
								<td>
								<c:if test="${empty l[8] }">
								<a href="javascript:void(0)" onclick="mload('${pageContext.request.contextPath}/bimr/archives/companyTree/EmployeeAbilityInformation?accountablePeople=${l[3]}&accountablePeopleId=${l[4]}&projecttype=2&projectId=${l[5]}&id=${l[7]}&questionId=${l[6]}')">问责信息维护</a>
								</c:if>
								<c:if test="${!empty l[8] }">
								<a href="javascript:void(0)" onclick="mload('${pageContext.request.contextPath}/bimr/archives/companyTree/showDuty?accountableId=${l[7]}')">查看</a>
