		...
		<div class="table_content">
			<form id="form1" class="row"  >
				...
				<div class="form_div col-md-12">
					<c:if test="${fn:contains(gzwsession_code,',bimWork_voluntarySh_query,')==true }">
			...
			<div class="tablebox">
				<table>
					<tr class="table_header">
						...
						<th style="width:21%" colspan="3">重大事项数据采集1</th>
						<th style="width:23%" colspan="3">重大事项数据采集2</th>
						...
						<c:forEach items="${ requestScope.msgPage.list}" var="resultList" varStatus="status">
							<tr>
								...
								<td>
									...
									<c:if test="${resultList.status==50113 }">
										<c:if test="${fn:contains(gzwsession_code,',bimWork_voluntarySh_exam,')==true }">
