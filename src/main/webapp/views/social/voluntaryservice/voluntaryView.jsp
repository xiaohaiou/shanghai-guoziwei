...
<body>
	<c:choose>
		<c:when test="${op eq 'report'}">
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>党建工作信息采集
...
<script type="text/javascript">
		...
		$("#commit-2").click(function(){
			var url = "/shanghai-gzw/social/voluntaryservice/report?id=" + id;
