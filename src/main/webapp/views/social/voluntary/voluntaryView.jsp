...
<body>
	<c:choose>
		<c:when test="${op eq 'report'}">
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>志愿服务与员工关爱数据上报
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:when>
		<c:otherwise>
			<h4>
				<span class="glyphicon glyphicon-pencil"></span>志愿服务与员工关爱数据查看
				<i class="iconfont icon-guanbi"></i>
			</h4>
		</c:otherwise>
	</c:choose>
...
<script type="text/javascript">
		...
		$("#commit-2").click(function(){
			var url = "/shanghai-gzw/social/voluntary/report?id=" + id;
