	...
	<div no=text class="l_top l_top_bg2">
		...
		<div class="menu user" no="text">
			<div>
				...
				<!-- <div class="title">${gzwsession_users.vcPostName}</div> -->
			</div>
		...
		<a class="menu i i_btn" no=text href="/bim_show/index.jsp?vcEmployeeId=${gzwsession_users.vcEmployeeId}&pageId=1">
			<img icon src="<c:url value="/img/asset.png"/>" alt="运营管控平台">
		</a>
		
		<a class="menu i i_btn" no=text href="${pageContext.request.contextPath}/manager/_frame?vcEmployeeId=${gzwsession_users.vcEmployeeId}" >
		...
		<div class="r1" no=text>
			...
			<div class="c1">
				<section class="order tab" style="height:1026px">
					<header>
						<span class=title>指令中心</span><i><a href="/bim_task/system/index?vcEmployeeId=${gzwsession_users.vcEmployeeId}&taskOrInstruction=instruction"><img src="<c:url value="/css/icon/more.png"/>" alt="更多"/></a></i><span class="click new bg-blue" onclick="mload('${pageContext.request.contextPath}/task/instruction/_add')">+&nbsp;指令下达 </span>
					</header>
			...
			<div class="c3">
				<section class="alert">
					...
					<ul no=text>
						<li>
							<div class="num" onclick="alarmKPI(${gzwsession_users.vcEmployeeId},${alarmCount})">${alarmCount}</div>
							<div class="hr"></div>
							<div class="name">KPI预警</div>
							<i><img src="<c:url value="/css/icon/KPI.png"/>" alt="KPI预警"></i>
						</li>
						<li>
							<div class="num" id="jd" onclick="alarmTime(${gzwsession_users.vcEmployeeId})"></div>
							<div class="hr"></div>
				...
				<section class="application tab" style="height:548px;">
					...
					<ul class="body">
							<a class="link management" href="/bim_show/sys/adConnect/_adConnect2?vcEmployeeId=${gzwsession_users.vcEmployeeId}&pageId=1"><img class="img-big" src="<c:url value="/img/hhsy.png"/>" alt="海航实业运营管控平台"></a>
						</li>
						<li>
						...
						<li>
							<ul class="group">
								<li>
									<a class="link" href="http://10.127.26.94:60002/hna_assistant/AdminMain/Index" target="blank">
