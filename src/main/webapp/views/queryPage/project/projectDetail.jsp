	...
	<div class="model_body">
		<form id="form2">
			...
			<div class="label_inpt_div">
				...
				<label class="w25 setleft"><fmt:formatNumber  value="${project.pjProgress/100}" pattern="#,##0%"/></label>
				<label class="w20">项目合同付整体款进度:</label>
				<label class="w25 setleft"><fmt:formatNumber  value="${project.totalContractProgress/100}" pattern="#,##0%"/></label>
				<br/>
				...
				<c:if test="${(not empty project.reportPersonName) && (empty project.approveId)}">
			...
			<div class="label_inpt_div" id="nodeList">
			
			</div>
			
			
			<h3 class="data_title1">周报信息列表</h3>
			<div class="label_inpt_div" id="wkReportList">
				
			</div>
			
			<h3 class="data_title1">合同信息列表</h3>
			<div class="label_inpt_div" id="contractList">
				
			</div>
			<h3 class="data_title1">上报审核历史信息</h3>
			<div class="label_inpt_div" id="history">
				<div class="tablebox">
					<table >
