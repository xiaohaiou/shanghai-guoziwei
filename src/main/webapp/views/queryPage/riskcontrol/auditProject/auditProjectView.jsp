	...
	<form:form id="form2" modelAttribute="auditProject" method="post">
		...
		<div id="sjfxwtslwh">
			...
			<div class="model_part">
				...
				<label class="w25 setleft">${ auditProject.auditProjectFindQuestion.financialControl}个</label><br>
				...
				<label class="w25 setleft">${ auditProject.auditProjectFindQuestion.purchaseManagement}个</label><br>
				...
				<label class="w25 setleft">${ auditProject.auditProjectFindQuestion.projectInvestment}个</label><br>
				...
				<label class="w25 setleft">${ auditProject.auditProjectFindQuestion.administrativeAffairs}个</label><br>
						...
						<c:if test="${!empty requestScope.auditProject.auditProjectAbarbeitungQuestionList}">
							<c:forEach items="${ requestScope.auditProject.auditProjectAbarbeitungQuestionList}" var="auditProjectAbarbeitungQuestion" varStatus="status">
								<tr>
									...
									<td>
										<a href="javascript:void(0)" onclick="mload('${pageContext.request.contextPath}/riskcontrol/auditProject/viewAbarbeitungQuestion?op=check&id=${auditProjectAbarbeitungQuestion.id}')">查看</a>
									</td>
								</tr>
							</c:forEach>
						</c:if>
