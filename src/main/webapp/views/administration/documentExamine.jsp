...
<body>
	<h4>
		<span class="glyphicon glyphicon-pencil"></span>企业信息采集及时率
...
<script type="text/javascript">
		...
		function commit4(){
			...
			$.post("/shanghai-gzw/adDocument/commitexam",{entityid:$("#id").val(),lastModifyDate:$("#lastModifyDate").val(),examStr:$("#examStr").val(),examResult:50116},function(data){
		...
		function commit5(){
			...
			$.post("/shanghai-gzw/adDocument/commitexam",{entityid:$("#id").val(),lastModifyDate:$("#lastModifyDate").val(),examStr:$("#examStr").val(),examResult:50117},function(data){
	    		var commitresult=JSON.parse(data);
						if(commitresult.result==true)
