...
<body>
	<h4>
		<span class="glyphicon glyphicon-pencil"></span>预算采集信息审核
...
<script type="text/javascript">
		...
		function commit4(){
			...
			$.post("/shanghai-gzw/adSupervise/commitexam",{entityid:$("#id").val(),lastModifyDate:$("#lastModifyDate").val(),examStr:$("#examStr").val(),examResult:50116},function(data){
		...
		function commit5(){
			...
			$.post("/shanghai-gzw/adSupervise/commitexam",{entityid:$("#id").val(),lastModifyDate:$("#lastModifyDate").val(),examStr:$("#examStr").val(),examResult:50117},function(data){
	    		var commitresult=JSON.parse(data);
						if(commitresult.result==true)
