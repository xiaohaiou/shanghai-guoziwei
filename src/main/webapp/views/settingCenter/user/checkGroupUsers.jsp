...
　　		<div class = "model_content">
			<h4><span class="glyphicon glyphicon-pencil"></span>用户组人员查看</h4>
			<div style="overflow:scroll;overflow-x:hidden" class="model_body">
				<form action="">
					<div class="row"><label class="col-md-1">用户组编号:</label><input type="text" id="groupNum" name="groupNum" disabled="" value="${theGroup.groupNum }"></div>
					<div class="row"><label class="col-md-1">用户组名称:</label><input type="text" id="groupName" name="groupName" disabled="" value="${theGroup.groupName }"></div>
					<div class="row"><label class="col-md-1">用户组描述:</label><div class="jsms_textarea"><textarea name="groupDescription" id="groupDescription" disabled="">${theGroup.groupDescription }</textarea></div></div>
					<div class="tablebox">
						<table>
