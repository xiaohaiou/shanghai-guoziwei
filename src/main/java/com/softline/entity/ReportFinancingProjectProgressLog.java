...
/**
 * ReportFinancingProjectProgressLog entity. @author MyEclipse Persistence Tools
 */

public class ReportFinancingProjectProgressLog implements java.io.Serializable {
	...
	/** default constructor */
	public ReportFinancingProjectProgressLog() {
	}

	/** full constructor */
	public ReportFinancingProjectProgressLog(Integer financingProjectId,
