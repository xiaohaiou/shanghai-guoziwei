...
/**
 * TaxPayGroup entity. @author MyEclipse Persistence Tools
 */

public class TaxPayGroup implements java.io.Serializable {
	...
	/** default constructor */
	public TaxPayGroup() {
		this.item=new ArrayList<TaxPayItem>();
	}

	/** minimal constructor */
	public TaxPayGroup(Integer year, String org, String orgname,
	...
	/** full constructor */
	public TaxPayGroup(Integer year, Integer month, String org, String orgname,
	...
	public BigDecimal getCumulativeAnnualSubscription() {
		return cumulativeAnnualSubscription;
	}
	...
	public BigDecimal getPrevCumulativeAnnualSubscription() {
		return prevCumulativeAnnualSubscription;
	}
	...
	public List<TaxPayItem> getItem() {
		return item;
	}

	public void setItem(List<TaxPayItem> item) {
		this.item = item;
	}
