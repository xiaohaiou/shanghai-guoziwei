...
public class ReportWeeklyFinancingIntoDetail implements java.io.Serializable {
	...
	/** default constructor */
	public ReportWeeklyFinancingIntoDetail() {
	}

	/** full constructor */
	public ReportWeeklyFinancingIntoDetail(Integer weekId, String memberCompId,
