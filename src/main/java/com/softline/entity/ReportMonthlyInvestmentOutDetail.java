...
public class ReportMonthlyInvestmentOutDetail implements java.io.Serializable {
	...
	/** default constructor */
	public ReportMonthlyInvestmentOutDetail() {
	}

	/** full constructor */
	public ReportMonthlyInvestmentOutDetail(Integer monthId, String memberCompId,
