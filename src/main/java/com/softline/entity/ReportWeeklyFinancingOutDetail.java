...
public class ReportWeeklyFinancingOutDetail implements java.io.Serializable {
	...
	/** default constructor */
	public ReportWeeklyFinancingOutDetail() {
	}

	/** full constructor */
	public ReportWeeklyFinancingOutDetail(Integer weekId, String memberCompId,
