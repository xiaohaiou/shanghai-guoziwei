...
/**
 * PjWeekreport entity. @author MyEclipse Persistence Tools
 */

public class PjWeekreport implements java.io.Serializable {
	...
	/** minimal constructor */
	public PjWeekreport(Integer pjId, Integer isdel) {
		this.pjId = pjId;
		this.isdel = isdel;
	}

	/** full constructor */
	public PjWeekreport(Integer pjId, String wrTitle, String wrContent,
