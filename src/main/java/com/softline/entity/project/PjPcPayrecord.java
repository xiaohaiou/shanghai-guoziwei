...
/**
 * PjPcPayrecord entity. @author MyEclipse Persistence Tools
 */

public class PjPcPayrecord implements java.io.Serializable {
	...
	/** default constructor */
	public PjPcPayrecord() {
	}

	/** minimal constructor */
	public PjPcPayrecord(Integer isdel) {
		this.isdel = isdel;
	}

	/** full constructor */
	public PjPcPayrecord(Integer pcId,Integer payCount, Integer payPercent,
