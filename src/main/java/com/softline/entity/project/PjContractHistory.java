...
/**
 * PjContractHistory entity. @author MyEclipse Persistence Tools
 */

public class PjContractHistory implements java.io.Serializable {
	...
	/** default constructor */
	public PjContractHistory() {
	}

	/** minimal constructor */
	public PjContractHistory(Integer isdel) {
		this.isdel = isdel;
	}

	/** full constructor */
	public PjContractHistory(Integer contractId, Integer pjId, String pcNo,
			String pcName, String pcOperator, String pcOperatorName,
			String pcBodyA, String pcBodyB, Integer pcType, Double pcBdMoney,
			String bcUnit, Integer pcPayType, String pcSignDate,
			Double pcPaidMoney, String paidUnit, String pcRemark,
			Integer isImportant, Integer isdel, String createPersonName,
