...
/**
 * PjContract entity. @author MyEclipse Persistence Tools
 */

public class PjContract implements java.io.Serializable {
	...
	/** minimal constructor */
	public PjContract(Integer isdel) {
		this.isdel = isdel;
	}

	/** full constructor */
	public PjContract(Integer pjId, String pcNo, String pcName,
