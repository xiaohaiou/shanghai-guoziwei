...
/**
 * PjNode entity. @author MyEclipse Persistence Tools
 */

public class PjNode implements java.io.Serializable {
	...
	/** minimal constructor */
	public PjNode(Integer isdel) {
		this.isdel = isdel;
	}

	/** full constructor */
	public PjNode(Integer pjId, String pnName, String pnCompletionTime,
		...
		this.pnFinishTime = pnCompletionTime;
	}
