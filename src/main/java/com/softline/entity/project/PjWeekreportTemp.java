...
/**
 * PjWeekreportTemp entity. @author MyEclipse Persistence Tools
 */

public class PjWeekreportTemp implements java.io.Serializable {
	...
	//临时字段
	private HhFile wkPDFFile;

	// Constructors

	/** default constructor */
	public PjWeekreportTemp() {
	}

	/** minimal constructor */
	public PjWeekreportTemp(Integer pjId, Integer isdel) {
		this.pjId = pjId;
		this.isdel = isdel;
	}

	/** full constructor */
	public PjWeekreportTemp(Integer pjId, String wrTitle, String wrContent,
			String wrYear, Integer wrWeek, String wrDatetime, String wrLine,
	...
	public HhFile getWkPDFFile() {
		return wkPDFFile;
	}

	public void setWkPDFFile(HhFile wkPDFFile) {
		this.wkPDFFile = wkPDFFile;
	}
