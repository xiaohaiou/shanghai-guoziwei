...
/**
 * ReportPersonalloan entity. @author MyEclipse Persistence Tools
 */

public class ReportPersonalloan implements java.io.Serializable {
	...
	private List<ReportPersonlloaninfo> infolist = new ArrayList<ReportPersonlloaninfo>(); 
	...
	/** default constructor */
	public ReportPersonalloan() {
	}

	/** minimal constructor */
	public ReportPersonalloan(Integer year, Integer status, Integer isdel) {
		this.year = year;
		this.status = status;
		this.isdel = isdel;
	}
	...
	/** full constructor */
	public ReportPersonalloan(Integer year, Integer month, String org,
	...
	public List<ReportPersonlloaninfo> getInfolist() {
		return infolist;
	}

	public void setInfolist(List<ReportPersonlloaninfo> infolist) {
