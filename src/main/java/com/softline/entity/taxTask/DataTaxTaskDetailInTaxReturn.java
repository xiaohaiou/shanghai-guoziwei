...
/**
 * DataTaxTaskDetailInTaxReturn entity. @author MyEclipse Persistence Tools
 */

public class DataTaxTaskDetailInTaxReturn implements java.io.Serializable {
	...
	/** default constructor */
	public DataTaxTaskDetailInTaxReturn() {
	}

	/** minimal constructor */
	public DataTaxTaskDetailInTaxReturn(Integer isdel) {
		this.isdel = isdel;
	}

	/** full constructor */
	public DataTaxTaskDetailInTaxReturn(Integer pid,DataTaxTask dataTaxTask, Integer year,
