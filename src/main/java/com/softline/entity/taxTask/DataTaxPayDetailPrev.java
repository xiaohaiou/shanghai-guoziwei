...
/**
 * DataTaxPayDetailPrev entity. @author MyEclipse Persistence Tools
 */

public class DataTaxPayDetailPrev implements java.io.Serializable {
	...
	/** default constructor */
	public DataTaxPayDetailPrev() {
	}

	/** minimal constructor */
	public DataTaxPayDetailPrev(Integer isdel) {
		this.isdel = isdel;
	}

	/** full constructor */
	public DataTaxPayDetailPrev(DataTaxPay dataTaxPay, String year,
