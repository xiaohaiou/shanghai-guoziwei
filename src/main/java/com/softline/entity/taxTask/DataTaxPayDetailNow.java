...
/**
 * DataTaxPayDetailNow entity. @author MyEclipse Persistence Tools
 */

public class DataTaxPayDetailNow implements java.io.Serializable {
	...
	/** default constructor */
	public DataTaxPayDetailNow() {
	}

	/** minimal constructor */
	public DataTaxPayDetailNow(Integer isdel) {
		this.isdel = isdel;
	}

	/** full constructor */
	public DataTaxPayDetailNow(DataTaxPay dataTaxPay, String year,
			...
			String otherTax, String sum, Integer isdel, String parentorg, Integer type) {
