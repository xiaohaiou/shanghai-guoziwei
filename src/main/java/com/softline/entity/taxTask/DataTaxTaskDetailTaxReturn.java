...
/**
 * DataTaxTaskDetailTaxReturn entity. @author MyEclipse Persistence Tools
 */

public class DataTaxTaskDetailTaxReturn implements java.io.Serializable {
	...
	/** default constructor */
	public DataTaxTaskDetailTaxReturn() {
	}

	/** minimal constructor */
	public DataTaxTaskDetailTaxReturn(Integer isdel) {
		this.isdel = isdel;
	}

	/** full constructor */
	public DataTaxTaskDetailTaxReturn(Integer pid,DataTaxTask dataTaxTask, Integer year,
