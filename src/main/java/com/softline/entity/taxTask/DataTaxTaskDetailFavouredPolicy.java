...
/**
 * DataTaxTaskDetailFavouredPolicy entity. @author MyEclipse Persistence Tools
 */

public class DataTaxTaskDetailFavouredPolicy implements java.io.Serializable {
	...
	/** default constructor */
	public DataTaxTaskDetailFavouredPolicy() {
	}

	/** minimal constructor */
	public DataTaxTaskDetailFavouredPolicy(Integer isdel) {
		this.isdel = isdel;
	}

	/** full constructor */
	public DataTaxTaskDetailFavouredPolicy(Integer pid, DataTaxTask dataTaxTask,
			Integer year, String org, String orgName, String month1,
			String month2, String month3, String month4, String month5,
			String month6, String month7, String month8, String month9,
			String month10, String month11, String month12, String sum,
