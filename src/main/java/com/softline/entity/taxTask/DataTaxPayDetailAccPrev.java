...
/**
 * DataTaxPayDetailAccPrev entity. @author MyEclipse Persistence Tools
 */

public class DataTaxPayDetailAccPrev implements java.io.Serializable {
	...
	/** default constructor */
	public DataTaxPayDetailAccPrev() {
	}

	/** minimal constructor */
	public DataTaxPayDetailAccPrev(Integer isdel) {
		this.isdel = isdel;
	}

	/** full constructor */
	public DataTaxPayDetailAccPrev(DataTaxPay dataTaxPay, String year,
