...
/**
 * HhUserspostrecord entity. @author MyEclipse Persistence Tools
 */

public class HhUserspostrecord implements java.io.Serializable {
	...
	/** default constructor */
	public HhUserspostrecord() {
	}

	/** minimal constructor */
	public HhUserspostrecord(String vcEmployeeId) {
		this.vcEmployeeId = vcEmployeeId;
	}

	/** full constructor */
	public HhUserspostrecord(String vcEmployeeId, String ipostRecordId,
	...
	public static HhUserspostrecord ConvertTo(HhUserspostrecord hhUserspostrecord, SDK_empPostRecord empPostRecord)
	{
		if(hhUserspostrecord==null)
		 hhUserspostrecord = new HhUserspostrecord();
		hhUserspostrecord.setVcEmployeeId(Common.notEmpty(empPostRecord.getVcEmployeeID())?empPostRecord.getVcEmployeeID():"");
		hhUserspostrecord.setIpostRecordId(Common.notEmpty(empPostRecord.getiPostRecordID())?empPostRecord.getiPostRecordID():"");
		hhUserspostrecord.setVcOrganId(Common.notEmpty(empPostRecord.getVcOrganID())?empPostRecord.getVcOrganID():"");
		hhUserspostrecord.setVcPostName(Common.notEmpty(empPostRecord.getVcPostName())?empPostRecord.getVcPostName():"");
		hhUserspostrecord.setNnodeId(Common.notEmpty(empPostRecord.getnNodeID())?empPostRecord.getnNodeID():"");
		hhUserspostrecord.setVcAdminLevelName(Common.notEmpty(empPostRecord.getVcAdminLevelName())?empPostRecord.getVcAdminLevelName():"");
		hhUserspostrecord.setVcHoldPost(Common.notEmpty(empPostRecord.getVcHoldPost())?empPostRecord.getVcHoldPost():"");
		hhUserspostrecord.setCifMost(Common.notEmpty(empPostRecord.getcIfMost())?empPostRecord.getcIfMost():"");
		hhUserspostrecord.setCifSideLine(Common.notEmpty(empPostRecord.getcIfSideLine())?empPostRecord.getcIfSideLine():"");
		hhUserspostrecord.setDoperatorDate(Common.notEmpty(empPostRecord.getdOperatorDate())?empPostRecord.getdOperatorDate():"");
		hhUserspostrecord.setCifMorB(Common.notEmpty(empPostRecord.getcIfMorB())?empPostRecord.getcIfMorB():"");
