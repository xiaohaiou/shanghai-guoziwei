...
public class DataTaxSave implements java.io.Serializable {
	...
	private String sumTaxSave;
	
	private String authOrg; // 数据权限控制字段
	

	public String getSumTaxSave() {
		return sumTaxSave;
	}

	public void setSumTaxSave(String sumTaxSave) {
		this.sumTaxSave = sumTaxSave;
	}
	...
	/** minimal constructor */
	public DataTaxSave(Integer status, Integer isdel) {
		this.status = status;
		this.isdel = isdel;
	}

	/** full constructor */
	public DataTaxSave(String year, String month, String org, String orgName,
			...
			String accTaxSave, String remark, Integer status, Integer isdel,
			...
			String parentorg, Set<DataTaxSaveDetail> dataTaxSaveDetails,String sumTaxSave,
