...
/**
 * BimrRiskEventAdoptstrategyFeedbcak entity. @author MyEclipse Persistence
 * Tools
 */

public class BimrRiskEventAdoptstrategyFeedback implements java.io.Serializable {
	...
	/** default constructor */
	public BimrRiskEventAdoptstrategyFeedback() {
	}

	/** minimal constructor */
	public BimrRiskEventAdoptstrategyFeedback(Integer isDel) {
		this.isDel = isDel;
	}

	/** full constructor */
	public BimrRiskEventAdoptstrategyFeedback(Integer eventId,
			String feedbacktime, Integer adoptStrategy,
