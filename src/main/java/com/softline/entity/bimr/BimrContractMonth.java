...
/**
 * BimrContractMonth entity. @author MyEclipse Persistence Tools
 */

public class BimrContractMonth implements java.io.Serializable, IEntityAuthorization {
	...
	/** default constructor */
	public BimrContractMonth() {
	}

	/** minimal constructor */
	public BimrContractMonth(Integer version) {
		this.version = version;
	}

	/** full constructor */
	public BimrContractMonth(Integer year, Integer month, String compId,
			Integer totalContract, BigDecimal totalMoney, String createPersonName,
			String createPersonId, String createDate,
			String lastModifyPersonId, String lastModifyPersonName,
			String lastModifyDate, Integer status, Integer version,
