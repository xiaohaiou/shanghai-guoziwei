...
/**
 * ReportFinancingShareEnclosure entity. @author MyEclipse Persistence Tools
 */

public class ReportFinancingShareEnclosure implements java.io.Serializable {
	...
	/** default constructor */
	public ReportFinancingShareEnclosure() {
	}

	/** full constructor */
	public ReportFinancingShareEnclosure(Integer financingProjectId,
