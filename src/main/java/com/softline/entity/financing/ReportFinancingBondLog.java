...
/**
 * ReportFinancingBondLog entity. @author MyEclipse Persistence Tools
 */

public class ReportFinancingBondLog implements java.io.Serializable {
	...
	/** default constructor */
	public ReportFinancingBondLog() {
	}

	/** full constructor */
	public ReportFinancingBondLog(Integer financingProjectId,
