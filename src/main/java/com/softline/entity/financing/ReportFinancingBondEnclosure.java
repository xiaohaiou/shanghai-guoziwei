...
/**
 * ReportFinancingBondEnclosure entity. @author MyEclipse Persistence Tools
 */

public class ReportFinancingBondEnclosure implements java.io.Serializable {
	...
	/** default constructor */
	public ReportFinancingBondEnclosure() {
	}

	/** full constructor */
	public ReportFinancingBondEnclosure(Integer financingProjectId,
