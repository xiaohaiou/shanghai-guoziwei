...
/**
 * ReportFinancingShareLog entity. @author MyEclipse Persistence Tools
 */

public class ReportFinancingShareLog implements java.io.Serializable {
	...
	/** default constructor */
	public ReportFinancingShareLog() {
	}

	/** full constructor */
	public ReportFinancingShareLog(Integer financingProjectId,
