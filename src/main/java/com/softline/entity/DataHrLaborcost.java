...
public class DataHrLaborcost implements java.io.Serializable {
	...
	/** default constructor */
	public DataHrLaborcost() {
	}

	/** minimal constructor */
	public DataHrLaborcost(Integer year, Integer month, String company,
	...
	/** full constructor */
	public DataHrLaborcost(Integer year, Integer month, String company,
			String organalId, Double businessIncome, Double laborCost,
			Double hrRateReturn, Integer status, String examineTime,
			Integer isdel, String reportPersonName, String reportPersonId,
			String reportDate, String auditorPersonName,
			String auditorPersonId, String auditorDate,
			String createPersonName, String createPersonId, String createDate,
			String lastModifyPersonId, String lastModifyPersonName,
			String lastModifyDate, String foreignKey) {
		this.year = year;
		this.month = month;
		this.company = company;
		this.organalId = organalId;
