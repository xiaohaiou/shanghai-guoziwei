 ...
 *
 */
public interface ISocialVoluntaryService {
	 ...
	 * @return
	 */
	public MsgPage getSocialVoluntaryListView(DataSocialVoluntary entity, Integer curPageNum, Integer pageSize, Integer fun);
	 ...
	 * @return
	 */
	public CommitResult saveSocialVoluntary(DataSocialVoluntary entity,HhUsers use,String type);
