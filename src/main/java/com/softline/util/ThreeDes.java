   ...
   private static int toByte(char c) {
    ...
    public static void main(String[] args) {  
		...
		try {
	        ...
	        byte[] srcBytes = decryptMode(keyBytes, hexStringToByte(nkey));  
	        System.out.println("解密后的字符串:" + new String(srcBytes));  
	        
	        
	        String name = "/opt_1/bimr_work/BimrCriminalcaseWeek";
	        System.out.println("加密前的用户名:" + name);  
	  	  
	        byte[] nameDecode = encryptMode(keyBytes, name.getBytes());  
	        
	        String namekey=  byte2hex(nameDecode);
	        System.out.println("加密后的用户名:" + namekey); 
	        
	        //System.out.println(hexStringToByte(byte2hex(encoded)));
	  
	        byte[] nameBytes = decryptMode(keyBytes, hexStringToByte("F2285285EA59C8DED2E277CC10903B84C4DEDF688966F6C8CF3CFE0CA15D53BA9DA99E4E6C88420A"));  
	        System.out.println("解密后的用户名:" + new String(nameBytes));
