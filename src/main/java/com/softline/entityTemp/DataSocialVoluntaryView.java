...
public class DataSocialVoluntaryView {
	...
	// 员工关爱活动人均参与度
	private String careParticipation;
	...
	/** default constructor */
	public DataSocialVoluntaryView() {
		super();
	}

	/** minimal constructor */
	public DataSocialVoluntaryView(Integer year, Integer month,
			String serviceCount, String serviceDuration, String servicePerson,
			String careCount, String carePerson, String careParticipation,
	...
	public String getCareParticipation() {
		return this.careParticipation;
	}

	public void setCareParticipation(String careParticipation) {
		this.careParticipation = careParticipation;
	}
