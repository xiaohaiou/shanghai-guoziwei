...
@Controller
@RequestMapping("/reportMonthlyInvestmentOutDetail")
/**
 * 
 * @author tch
 *
 */
public class ReportMonthlyInvestmentOutDetailController {
	...
	public String _list(String stringList, Integer pageNums, String op, HttpServletRequest request ,Map<String, Object> map) throws IOException {
		...
		List<ReportMonthlyInvestmentOutDetail> list = new ArrayList<ReportMonthlyInvestmentOutDetail>();
		if(stringList != null && !"".equals(stringList))
			list=JSON.parseArray(stringList, ReportMonthlyInvestmentOutDetail.class);
        //根据list，设置分页
		...
		List<ReportMonthlyInvestmentOutDetail> newList = new ArrayList<ReportMonthlyInvestmentOutDetail>();
	    ...
	    //控制分页
	    map.put("flag", "reportMonthlyInvestmentOutDetail");
	    map.put("searchurl", "/shanghai-gzw/reportMonthlyInvestmentOutDetail/list");
		addData(map);
		return "/report/reportCashflowMonthlyExecute/reportMonthlyInvestmentOutDetail/reportMonthlyInvestmentOutDetailList";
	}
	...
	public String _view(String stringList, Integer pageNums,HttpServletRequest request ,Map<String, Object> map,String op) throws IOException {
	    ...
	    //控制分页
	    map.put("flag", "reportMonthlyInvestmentOutDetail");
	    map.put("searchurl", "/shanghai-gzw/reportMonthlyInvestmentOutDetail/viewList");
		return "/report/reportCashflowMonthlyExecute/reportMonthlyInvestmentOutDetail/reportMonthlyInvestmentOutDetailViewList";
	}
	...
	public String exportExcel(String excelName, String excelData, HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		List<ReportMonthlyInvestmentOutDetail> dataList = new ArrayList<ReportMonthlyInvestmentOutDetail>();
		if(excelData != null && !"".equals(excelData))
			dataList=JSON.parseArray(excelData, ReportMonthlyInvestmentOutDetail.class);
	...
	private List<Map<String, Object>> createExcelRecord(List<ReportMonthlyInvestmentOutDetail> dataList) {
    	...
    	for (int i = 0; i < 500; i++) {//默认给500条
    		 if(i<j) {
    			 ReportMonthlyInvestmentOutDetail detail=dataList.get(i);
	...
	public void dealSelect(List<Object> listob) {
		...
		for(Object obj:listob) {
			ReportMonthlyInvestmentOutDetail detail = (ReportMonthlyInvestmentOutDetail)obj;
			for(HhBase base:currencyKind){
